...
with st.sidebar:
    ...
    <div style='margin-top:30px;'>
        ...
        <a href='https://pagina-busqueda-ia.streamlit.app/' target='_blank'><button class='btn' style='width:100%;margin-bottom:12px;background-color:#002855;'>ANÁLISIS DEL DELITO CON IA</button></a>
    </div>
